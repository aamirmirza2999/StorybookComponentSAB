...
import { CheckboxUnSelected, Delete, EditBlack, InfoIconRed, RadioUnSelect, RightArrow, Slices, TextInfoIcon, TextInfoIconDark, TickIcon, Toggle, Toggleunselect } from '../../constants/SvgLocations';
...
const DarkThemeBlock = (props) => {
    ...
    const getDefaultAction = () => {
        switch (props.listItemActionType) {
            ...
            case 'Chevron':
                return <RightArrow width={spacingL} height={spacingL} />;
            case 'Radio Button':
